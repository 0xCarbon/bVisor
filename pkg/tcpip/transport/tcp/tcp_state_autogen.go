...
func (e *Endpoint) StateSave(stateSinkObject state.Sink) {
	...
	stateSinkObject.SaveValue(16, stateValue)
	...
	stateSinkObject.Save(7, &e.egressL7Required)
	stateSinkObject.Save(8, &e.egressL7Hold)
	stateSinkObject.Save(9, &e.egressL7Prefix)
	stateSinkObject.Save(10, &e.egressL7Rounds)
	stateSinkObject.Save(11, &e.lastError)
	stateSinkObject.Save(12, &e.TCPRcvBufState)
	stateSinkObject.Save(13, &e.rcvMemUsed)
	stateSinkObject.Save(14, &e.ownedByUser)
	stateSinkObject.Save(15, &e.rcvQueue)
	stateSinkObject.Save(17, &e.connectionDirectionState)
	stateSinkObject.Save(18, &e.isPortReserved)
	stateSinkObject.Save(19, &e.isRegistered)
	stateSinkObject.Save(20, &e.boundNICID)
	stateSinkObject.Save(21, &e.ipv4TTL)
	stateSinkObject.Save(22, &e.ipv6HopLimit)
	stateSinkObject.Save(23, &e.isConnectNotified)
	stateSinkObject.Save(24, &e.h)
	stateSinkObject.Save(25, &e.portFlags)
	stateSinkObject.Save(26, &e.boundBindToDevice)
	stateSinkObject.Save(27, &e.boundPortFlags)
	stateSinkObject.Save(28, &e.boundDest)
	stateSinkObject.Save(29, &e.effectiveNetProtos)
	stateSinkObject.Save(30, &e.recentTSTime)
	stateSinkObject.Save(31, &e.shutdownFlags)
	stateSinkObject.Save(32, &e.tcpRecovery)
	stateSinkObject.Save(33, &e.sack)
	stateSinkObject.Save(34, &e.delay)
	...
	stateSinkObject.Save(40, &e.sndQueueInfo)
	stateSinkObject.Save(41, &e.cc)
	stateSinkObject.Save(42, &e.keepalive)
	stateSinkObject.Save(43, &e.userTimeout)
	stateSinkObject.Save(44, &e.deferAccept)
	stateSinkObject.Save(45, &e.acceptQueue)
	stateSinkObject.Save(46, &e.rcv)
	stateSinkObject.Save(47, &e.snd)
	stateSinkObject.Save(48, &e.connectingAddress)
	stateSinkObject.Save(49, &e.amss)
	stateSinkObject.Save(50, &e.sendTOS)
	stateSinkObject.Save(51, &e.gso)
	stateSinkObject.Save(52, &e.stats)
	stateSinkObject.Save(53, &e.tcpLingerTimeout)
	stateSinkObject.Save(54, &e.closed)
	stateSinkObject.Save(55, &e.txHash)
	stateSinkObject.Save(56, &e.owner)
	stateSinkObject.Save(57, &e.ops)
	stateSinkObject.Save(58, &e.lastOutOfWindowAckTime)
	stateSinkObject.Save(59, &e.pmtud)
	stateSinkObject.Save(60, &e.alsoBindToV4)
	stateSinkObject.Save(61, &e.terminateAtRestore)
}
...
func (e *Endpoint) StateLoad(ctx context.Context, stateSourceObject state.Source) {
	...
	stateSourceObject.Load(7, &e.egressL7Required)
	stateSourceObject.Load(8, &e.egressL7Hold)
	stateSourceObject.Load(9, &e.egressL7Prefix)
	stateSourceObject.Load(10, &e.egressL7Rounds)
	stateSourceObject.Load(11, &e.lastError)
	stateSourceObject.Load(12, &e.TCPRcvBufState)
	stateSourceObject.Load(13, &e.rcvMemUsed)
	stateSourceObject.Load(14, &e.ownedByUser)
	stateSourceObject.LoadWait(15, &e.rcvQueue)
	stateSourceObject.Load(17, &e.connectionDirectionState)
	stateSourceObject.Load(18, &e.isPortReserved)
	stateSourceObject.Load(19, &e.isRegistered)
	stateSourceObject.Load(20, &e.boundNICID)
	stateSourceObject.Load(21, &e.ipv4TTL)
	stateSourceObject.Load(22, &e.ipv6HopLimit)
	stateSourceObject.Load(23, &e.isConnectNotified)
	stateSourceObject.Load(24, &e.h)
	stateSourceObject.Load(25, &e.portFlags)
	stateSourceObject.Load(26, &e.boundBindToDevice)
	stateSourceObject.Load(27, &e.boundPortFlags)
	stateSourceObject.Load(28, &e.boundDest)
	stateSourceObject.Load(29, &e.effectiveNetProtos)
	stateSourceObject.Load(30, &e.recentTSTime)
	stateSourceObject.Load(31, &e.shutdownFlags)
	stateSourceObject.Load(32, &e.tcpRecovery)
	stateSourceObject.Load(33, &e.sack)
	stateSourceObject.Load(34, &e.delay)
	...
	stateSourceObject.Load(40, &e.sndQueueInfo)
	stateSourceObject.Load(41, &e.cc)
	stateSourceObject.Load(42, &e.keepalive)
	stateSourceObject.Load(43, &e.userTimeout)
	stateSourceObject.Load(44, &e.deferAccept)
	stateSourceObject.Load(45, &e.acceptQueue)
	stateSourceObject.LoadWait(46, &e.rcv)
	stateSourceObject.LoadWait(47, &e.snd)
	stateSourceObject.Load(48, &e.connectingAddress)
	stateSourceObject.Load(49, &e.amss)
	stateSourceObject.Load(50, &e.sendTOS)
	stateSourceObject.Load(51, &e.gso)
	stateSourceObject.Load(52, &e.stats)
	stateSourceObject.Load(53, &e.tcpLingerTimeout)
	stateSourceObject.Load(54, &e.closed)
	stateSourceObject.Load(55, &e.txHash)
	stateSourceObject.Load(56, &e.owner)
	stateSourceObject.Load(57, &e.ops)
	stateSourceObject.Load(58, &e.lastOutOfWindowAckTime)
	stateSourceObject.Load(59, &e.pmtud)
	stateSourceObject.Load(60, &e.alsoBindToV4)
	stateSourceObject.Load(61, &e.terminateAtRestore)
	stateSourceObject.LoadValue(16, new(EndpointState), func(y any) { e.loadState(ctx, y.(EndpointState)) })
